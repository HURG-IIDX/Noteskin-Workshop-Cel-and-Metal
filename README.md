...
This noteskin also supports lifts. There are a few lift types for both both Cel and Metal, these colors should be visually distinct for whataver arrow customization you use. By default, they come with the spectrum versions.
Here is a preview of some of the lift animations:
